...
DEFAULT_PROFILES: dict[str, ProfileConfig] = {
    ...
    "codex_worker": ProfileConfig(model="gpt-5.6-sol", reasoning_effort="high"),
    "codex_planner": ProfileConfig(model="gpt-5.6-sol", reasoning_effort="high"),
    "codex_auditor": ProfileConfig(model="gpt-5.6-sol", reasoning_effort="high"),
    "codex_literature": ProfileConfig(model="gpt-5.6-sol", reasoning_effort="high"),
