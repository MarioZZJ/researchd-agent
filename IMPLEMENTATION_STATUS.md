...
| 2 | 单元、集成、conformance、recovery、e2e 测试通过 | PARTIAL | 127 passed + 2 门控跳过（含 e2e 黄金路径 22 步）；真实平台 GATED |
...
| 9 | systemd/user-systemd 启动、停止、自动恢复 | PENDING | Phase 9（下一阶段） |
